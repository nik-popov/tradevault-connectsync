          ...
          <Box flex="1">
            ...
            {isLocked ? (
              <Alert status="warning" borderRadius="md">
                <AlertIcon />
                <Text>Support is available only for subscribers. Please upgrade your plan.</Text>
              </Alert>
            ) : isFullyDeactivated ? (
              <Alert status="error" borderRadius="md">
                <AlertIcon />
                <Flex justify="space-between" align="center" w="full">
                  <Text>Your subscription has been deactivated. Renew to access support.</Text>
              ...
              <>
                <Box p={6} border="1px solid" borderColor="gray.200" borderRadius="md" boxShadow="sm">
                  ...
                  <Button colorScheme="blue" leftIcon={<FiSend />} size="lg" isLoading={isSubmitting} onClick={handleSubmit}>
                    Submit Request
                  </Button>
                </Box>
              </>
