    ...
    const steps = [
        {
            ...
            content: (_jsx(Code, { p: 3, borderRadius: "md", fontSize: "sm", bg: "gray.700", children: `curl -X GET "https://api.iconluxury.group/api/v1/endpoints?type=datacenter-mobile"` })),
        },
        {
            title: "Get Available Locations",
            icon: FiGlobe,
            description: "Retrieve a list of supported locations for datacenter mobile proxies.",
            content: (_jsx(Code, { p: 3, borderRadius: "md", fontSize: "sm", bg: "gray.700", children: `curl -X GET "https://api.iconluxury.group/api/v1/locations?type=datacenter-mobile"` })),
        },
        {
            title: "Configure Your Endpoint",
            icon: FiGlobe,
            description: "Connect to our datacenter mobile proxy network using this endpoint.",
            content: (_jsx(Code, { p: 3, borderRadius: "md", fontSize: "sm", bg: "gray.700", children: "https://api.iconluxury.group/api/v1/proxy/datacenter-mobile/" })),
        },
        {
        ...
        },
        {
            ...
            content: (_jsx(Code, { p: 3, borderRadius: "md", fontSize: "sm", bg: "gray.700", children: `curl -X GET "https://api.iconluxury.group/api/v1/auth/datacenter-mobile"` })),
        },
        {
